...
type User struct {
	...
	CreateTime             *data.DbDateTime `json:"create_time" gorm:"create_time"`                             // 创建时间
	UpdateTime             *data.DbDateTime `json:"update_time" gorm:"update_time"`                             // 最后更新时间
	...
	SignTime               *data.DbDate     `json:"sign_time" gorm:"sign_time"`                                 // 签约时间
	EndDate                *data.DbDate     `json:"end_date" gorm:"end_date"`                                   // 到期日期
	...
	AgreementEndDate       *data.DbDate     `json:"agreement_end_date" gorm:"agreement_end_date"`               // 合同结束日期
	AgreementStartDate     *data.DbDate     `json:"agreement_start_date" gorm:"agreement_start_date"`           // 合同开始日期
	...
	LastChangePasswordTime *data.DbDateTime `json:"last_change_password_time" gorm:"last_change_password_time"` // 最后一次修改密码时间
	...
	ActiveDate             *data.DbDate     `json:"active_date" gorm:"active_date"`                             // 最近活跃时间
